...
- [ ] Create PR 1 for the completed first-party `sentinelforge-tools` MCP and incident-fixture milestone, wait for Qodo review, and record the outcome before any merge decision.
