...
- [x] Resolve Qodo finding QODO-PR1-003: align the pnpm development dependency with the `packageManager` pin, update the lockfile, and rerun CI before considering PR 1 complete.
